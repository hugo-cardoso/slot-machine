...
var audios = {
  ...
  winner: new _buzz2.default.sound("./dist/audio/winner.mp3"),
  lose: new _buzz2.default.sound("./dist/audio/lose.mp3")
};

var gameNumbers = [document.getElementById('gameNumber1'), document.getElementById('gameNumber2'), document.getElementById('gameNumber3')];
...
var setNumbers = function setNumbers() {
  ...
  return new Promise(function (resolve, reject) {
    setNumber(0).then(function () {
      return setNumber(1).then(function () {
        setNumber(2).then(function () {
          return resolve(true);
        });
      });
    });
...
var clearNumbers = function clearNumbers() {
  return gameNumbers.map(function (elem) {
...
var unlockStartButton = function unlockStartButton() {
